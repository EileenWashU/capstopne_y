...
def update_pie_chart(selected_site):
    if selected_site == 'ALL':
        fig = px.pie(
            ...
            color='Launch Site',
            category_orders={'Launch Site': sorted(spacex_df['Launch Site'].unique())},
            custom_data=['class']
        )
    else:
...
def update_scatter_plot(entered_site, payload_range):
    ...
    fig = px.scatter(
        ...
        title=f'Payload Mass vs. Success/Failure for {entered_site if entered_site != "ALL" else "All Sites"}',
